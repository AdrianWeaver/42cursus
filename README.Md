...
| 1   | snow_crash                       | ![snow_crash top language](https://img.shields.io/badge/-private-red)                       | ![snow_crash grade](https://img.shields.io/badge/:-125%25-success?style=flat-square&logo=42)            | This project is an introduction to computer security. Built as a sort of capture the flag project to get familiar with program errors and security flaws. The project explores ASM, php, perl, C, binary files and system configurations. |
